...
public class MemberAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM_HEADER) {
            View viewHeader = LayoutInflater.from(context).inflate(R.layout.item_member_leyout_header, parent, false);
            ...
            View viewNot = LayoutInflater.from(context).inflate(R.layout.item_member_layout_no, parent, false);
            return new MemberViewNotHolder(viewNot);
        }

        View viewFooter = LayoutInflater.from(context).inflate(R.layout.item_member_layout_footer, parent, false);
